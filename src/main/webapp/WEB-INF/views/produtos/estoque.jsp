            ...
            <table class="table" style="text-align: center;">
                ...
                <c:forEach items="${produtos}" var="produto">
                    <tr>
                        ...
                        <th scope="row" ><img style="margin: 25px auto 30px;width: 10%;" src="${produto.img1}"></th>
                        <td>${produto.modelo}</td>
                        <td>${produto.nome}</td>
                        <td>
                            <form method="post" action="/produtos/alterar/${produto.id}">
                                <input type="hidden" name="_method" value="put"/>
                                <input style="text-align: center; width: 55%;" class="form-control"
                                       type="number" name="quantidade" value="${produto.quantidade}"/>
                                <button class="btn btn-outline-primary"
                                        style="margin-top: -65px;margin-left: 65px;" type="submit">OK
                                </button>
                            </form>
                        </td>
                        <td>${produto.sexo}</td>
                        ...
                        <td>
                            <button class="btn btn-outline-primary"><a href="/produtos/edit/${produto.id}">Edit</a></button>
                        </td>
                        <td>
